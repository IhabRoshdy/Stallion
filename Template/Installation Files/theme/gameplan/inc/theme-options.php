  ...
  $custom_settings = array( 
	...
	array(
	  ...
	  array(
        ...
        'desc'        => 'If you change this option, you need to edit all your shortcodes to match new Font Awesome\'s icon class format. (All previous Gameplan versions are using Font Awesome 3.x)',
        'std'         => '3',
        'type'        => 'select',
        'section'     => 'general',
        'rows'        => '',
	  ...
	  array(
        'id'          => 'blog_show_cat',
        'label'       => esc_html__('Show Categories','cactusthemes'),
        'desc'        => esc_html__('Show item\'s categories info. This will affect blog list and single post page','cactusthemes'),
        'std'         => '',
        'type'        => 'radio',
        'section'     => 'blog',
        'rows'        => '',
	  ...
	  array(
        ...
        'label'       => esc_html__('Show Read More Link','cactusthemes'),
        'desc'        => esc_html__('Show Read More Link','cactusthemes'),
        'std'         => '',
        'type'        => 'radio',
        'section'     => 'blog',
        'rows'        => '',
      ...
      array(
        ...
        'choices'     => array( 
          array(
            'value'       => '1',
            'label'       => esc_html__('Use WP-PageNavi plugin','cactusthemes'),
            'src'         => ''
          ),
          array(
            'value'       => 'default',
...
//
    ...
    //Auto update block
       array(
        ...
        'desc'        => __('Enter your Envato username', 'cactusthemes' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'auto_update',
        'rows'        => '',
       ...
       array(
        'id'          => 'envato_api',
        'label'       => 'Envato API',
        'desc'        => __('Enter your Envato API. You can find your API under in Profile page > My Settings > API Keys', 'cactusthemes' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'auto_update',
        'rows'        => '',
       ...
       array(
        ...
        'label'       => __( 'Allow Auto Update', 'cactusthemes' ),
        'desc'        => __('Allow Auto Update or Not. If not, you can go to Appearance > Themes and click on Update link', 'cactusthemes' ),
        'std'         => 'off',
        'type'        => 'on-off',
        'section'     => 'auto_update',
        'rows'        => '',
  ...
  $custom_settings['sections'][]=array(
        'id'          => 'auto_update',
        'title'       => '<i class="gp_auto_update">Auto Update</i>'
  );	
